...
{       
        ...
        while(running){
                ...
                //printf("\r");
                fprintf(fp,"%.10lf,", (double)counter/1000000000);
                ...
                printf("\r");
                printf("%.10lf s        |", (double)counter/1000000000);
                ...
                fflush(stdout);
                rc_nanosleep(1000000000/SAMPLE_RATE - (rc_nanos_since_boot() - initial_time + 1185 - counter));
                counter = rc_nanos_since_boot() - initial_time + 1185;
                //if(counter >= 20*1000000000) break;
        }
        fclose(fp);
        printf("\n");
        rc_mpu_power_off();
